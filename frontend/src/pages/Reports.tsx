  ...
  return (
    <div className="flex-grow p-8 bg-[#0a0f1d] min-h-screen text-slate-100 flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-[#0c1325]/60 border border-slate-850 p-6 rounded-2xl flex items-center justify-between">
          <div>
      ...
      <div className="bg-[#0c1325]/40 border border-slate-800 border-dashed rounded-2xl p-16 flex flex-col items-center justify-center text-center flex-grow">
